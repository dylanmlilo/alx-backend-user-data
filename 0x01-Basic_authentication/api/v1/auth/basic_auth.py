#!/usr/bin/env python3
"""
Model that defines a BasicAuthentication class
"""
import base64
...
class BasicAuth(Auth):
    ...
    def decode_base64_authorization_header(self,
                                           ...
                                           str) -> str:
        """ decods a Base64-encoded string """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        if Auth_header is not None:
            tken = self.extract_base64_authorization_header(Auth_header)
            if tken is not None:
                decoded = self.decode_base64_authorization_header(tken)
